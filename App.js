  ...
  return (
    ...
    <View>
      ...
      <View style={{paddingLeft: 15, paddingRight: 15, marginTop: 80}}>
        ...
        <InputPerfil icone={iconPerfil} nome={'Nome Completo'}></InputPerfil>

        <InputPerfil icone={iconPerfil} nome={'CPF'}></InputPerfil>

        <InputPerfil icone={iconEmail} nome={'Email'}></InputPerfil>

        <InputPerfil icone={iconSenha} nome={'Senha'}></InputPerfil>
